child puppet: :puppet do
  extends 'foreman_puppet/api/v2/host_puppet_facets/show'
end
...
node do |host|
  { all_puppetclasses: partial('foreman_puppet/api/v2/puppetclasses/base', object: host.puppet.all_puppetclasses) }
end
