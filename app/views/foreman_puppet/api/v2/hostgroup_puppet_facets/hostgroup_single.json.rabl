child puppet: :puppet do
  extends 'foreman_puppet/api/v2/hostgroup_puppet_facets/show'
end
...
node do |hostgroup|
  { all_puppetclasses: partial('foreman_puppet/api/v2/puppetclasses/base', object: hostgroup.puppet.all_puppetclasses) }
end
