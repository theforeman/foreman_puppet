module ForemanPuppetEnc
  class PuppetSmartProxiesController < ApplicationController
    ...
    def environments
      render partial: 'foreman_puppet_enc/puppet_smart_proxies/environments', locals: { environments: @proxy_status[:puppet].environment_stats }
    ...
    def dashboard
      ...
      render partial: 'foreman_puppet_enc/puppet_smart_proxies/dashboard'
    rescue Foreman::Exception => e
      process_ajax_error e
    end
