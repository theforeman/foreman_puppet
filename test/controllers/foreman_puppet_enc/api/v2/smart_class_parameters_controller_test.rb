      ...
      class SmartClassParametersControllerTest < ActionController::TestCase
        ...
        context 'without override' do
          ...
          test "should not set avoid duplicates for non supported types" do
            put :update, params: { :id => lookup_key.id, :smart_class_parameter => { :override => true, :default_value => RFauxFactory.gen_alpha, :avoid_duplicates => true } }
          ...
          test "should not set merge overrides for non supported types" do
            put :update, params: { :id => lookup_key.id, :smart_class_parameter => { :override => true, :default_value => RFauxFactory.gen_alpha, :merge_overrides => true } }
          ...
          test "should not set merge default if merge overrides is not set" do
            put :update, params: { :id => lookup_key.id, :smart_class_parameter => { :override => true, :default_value => RFauxFactory.gen_alpha, :merge_default => true } }
          ...
          test "should not update default value if not in list" do
            default_value = RFauxFactory.gen_alphanumeric
            put :update, params: { :id => lookup_key.id, :smart_class_parameter => { :override => true, :default_value => default_value, :validator_type => "list", :validator_rule => "5, test" } }
          ...
          test "should not update default value if not match regexp" do
            ...
            put :update, params: { :id => lookup_key.id, :smart_class_parameter => { :override => true, :default_value => default_value, :validator_type => "regexp", :validator_rule => "[0-9]" } }
        ...
        test "should set avoid duplicates for supported types" do
          put :update, params: { :id => lookup_key.id, :smart_class_parameter => { :override => true, :parameter_type => "array", :default_value => "[#{RFauxFactory.gen_alpha}, #{RFauxFactory.gen_alpha}]", :avoid_duplicates => true, :merge_overrides => true } }
          assert_response :success
        ...
        test "should set merge overrides for supported types" do
          put :update, params: { :id => lookup_key.id, :smart_class_parameter => { :override => true, :parameter_type => "array", :default_value => "[#{RFauxFactory.gen_alpha}, #{RFauxFactory.gen_alpha}]", :merge_overrides => true, :merge_default => true } }
          assert_response :success
        ...
        test "should hide empty default value" do
          put :update, params: { :id => lookup_key.id, :smart_class_parameter => { :override => true, :default_value => "", :hidden_value => true } }
          assert_response :success
        ...
        test "should hide default value" do
          put :update, params: { :id => lookup_key.id, :smart_class_parameter => { :override => true, :default_value => RFauxFactory.gen_alpha, :hidden_value => true } }
          assert_response :success
          assert_equal JSON.parse(response.body)['hidden_value?'], true
          assert_equal JSON.parse(response.body)['default_value'], '*****'
        end
        ...
        test "should unhide default value" do
          value = RFauxFactory.gen_alpha
          lookup_key = FactoryBot.create(:puppetclass_lookup_key, :override => true, :default_value => value, :hidden_value => true, :puppetclass => puppetclass)
          get :show, params: { :id => lookup_key.id }
          assert_equal JSON.parse(response.body)['hidden_value?'], true
        ...
        test "update hidden value in parameter" do
          ...
          lookup_key = FactoryBot.create(:puppetclass_lookup_key, :override => true, :default_value => old_value, :hidden_value => true, :puppetclass => puppetclass)
          put :update, params: { :id => lookup_key.id, :smart_class_parameter => { :default_value => new_value } }
          lookup_key.reload
          assert_equal lookup_key.hidden_value?, true
        ...
        test "validate default value requires check" do
          put :update, params: { :id => lookup_key.id, :smart_class_parameter => { :override => true, :required => true, :parameter_type => "boolean", :default_value => true } }
          lookup_key.reload
          assert_equal lookup_key.required, true
          assert_equal lookup_key.default_value, true
        end
        ...
        test "validate default value with list" do
          ...
          put :update, params: { :id => lookup_key.id, :smart_class_parameter => { :override => true, :default_value => value, :validator_type => "list", :validator_rule => values_list_str } }
          assert_response :success
        ...
        test "should validate matcher with default type" do
          lookup_key = FactoryBot.create(:puppetclass_lookup_key, :override => true, :default_value => true, :parameter_type => 'boolean', :puppetclass => puppetclass)
