  ...
  class HostTest < ActiveSupport::TestCase
    ...
    describe '#complete_for' do
      ...
      test 'limits Puppet assignment completions to the current organization' do
        ...
        hidden_organization = FactoryBot.create(:organization)
        visible_environment = FactoryBot.create(
          :environment,
          organizations: [organization],
          locations: [location]
        )
        hidden_environment = FactoryBot.create(
          :environment,
          organizations: [hidden_organization],
          locations: [location]
        )
